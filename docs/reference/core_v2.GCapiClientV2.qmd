# core_v2.GCapiClientV2 { #pygcapi.core_v2.GCapiClientV2 }

```python
core_v2.GCapiClientV2(self, username, password, appkey)
```
...
| Name | Description |
| --- | --- |
| [close_all_trades](#pygcapi.core_v2.GCapiClientV2.close_all_trades) | Close all open trades with a given price tolerance. |
| [close_all_trades_new](#pygcapi.core_v2.GCapiClientV2.close_all_trades_new) | Close all trades using a provided list of open positions and a given tolerance. |
| [get_account_info](#pygcapi.core_v2.GCapiClientV2.get_account_info) | Retrieve account information. |
| [get_long_series](#pygcapi.core_v2.GCapiClientV2.get_long_series) | Retrieve a long time series of OHLC data by bypassing API limitations. |
| [get_market_info](#pygcapi.core_v2.GCapiClientV2.get_market_info) | Retrieve market information. |
| [get_ohlc](#pygcapi.core_v2.GCapiClientV2.get_ohlc) | Retrieve OHLC data for a specific market. |
| [get_prices](#pygcapi.core_v2.GCapiClientV2.get_prices) | Retrieve tick history (price data) for a specific market. |
| [get_trade_history](#pygcapi.core_v2.GCapiClientV2.get_trade_history) | Retrieve the trade history for the account. |
| [list_active_orders](#pygcapi.core_v2.GCapiClientV2.list_active_orders) | List all active orders. |
| [list_open_positions](#pygcapi.core_v2.GCapiClientV2.list_open_positions) | List all open positions. |
| [trade_order](#pygcapi.core_v2.GCapiClientV2.trade_order) | Place a trade order. |
...
### get_account_info { #pygcapi.core_v2.GCapiClientV2.get_account_info }
